  ...
  return (
    <div className="min-h-screen bg-surface-50 dark:bg-surface-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="w-20 h-20 bg-gradient-to-r from-brand-600 to-success-600 rounded-full flex items-center justify-center mx-auto mb-8">
            <Target className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-surface-900 dark:text-white mb-6">
            Biz Haqimizda
          </h1>
          <p className="text-lg sm:text-xl text-surface-600 dark:text-surface-300 max-w-3xl mx-auto leading-relaxed px-4">
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="w-16 h-16 bg-white dark:bg-surface-900 rounded-2xl shadow-sm flex items-center justify-center mx-auto mb-4">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-brand-600 to-success-600 rounded-3xl p-6 sm:p-12 text-white text-center mb-20"
        >
          <h2 className="text-2xl sm:text-3xl font-bold mb-6">Bizning Missiyamiz</h2>
          <p className="text-lg sm:text-xl text-brand-100 max-w-4xl mx-auto leading-relaxed px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-surface-900 rounded-2xl p-6 sm:p-8 shadow-sm border border-surface-200 dark:border-surface-800 hover:shadow-md transition-shadow duration-150"
              >
                <div className="w-12 h-12 bg-gradient-to-r from-brand-600 to-success-600 rounded-xl flex items-center justify-center mb-6">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg sm:text-xl text-surface-600 dark:text-surface-300 max-w-2xl mx-auto px-4">
          ...
          <div className="relative hidden md:block">
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-brand-600 to-success-600 rounded-full"></div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-4 h-4 bg-gradient-to-r from-brand-600 to-success-600 rounded-full"></div>
                  </div>
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 bg-white dark:bg-surface-900 rounded-2xl p-6 shadow-sm border border-surface-200 dark:border-surface-800">
                    <div className="text-2xl sm:text-3xl font-bold text-brand-600 mb-3">
                      {item.year}
                    </div>
                    <h3 className="text-xl sm:text-2xl font-semibold text-surface-900 dark:text-white mb-4">
                      {item.title}
                    </h3>
                    <p className="text-base sm:text-lg text-surface-600 dark:text-surface-300 leading-relaxed">
                      {item.description}
                    </p>
                  </div>
                </div>
                ...
                {index < timeline.length - 1 && (
                  <div className="absolute left-3 top-8 w-0.5 h-8 bg-gradient-to-b from-brand-600 to-success-600 rounded-full"></div>
                )}
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-surface-900 rounded-2xl p-6 shadow-sm border border-surface-200 dark:border-surface-800 hover:shadow-md transition-shadow duration-150 text-center"
              >
        ...
        <motion.div
          ...
          className="bg-white dark:bg-surface-900 rounded-3xl p-6 sm:p-12 text-center shadow-sm border border-surface-200 dark:border-surface-800"
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-surface-900 dark:text-white mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 max-w-2xl mx-auto">
            <div className="bg-surface-50 dark:bg-surface-700 rounded-2xl p-4 sm:p-6">
              <div className="w-12 h-12 bg-gradient-to-r from-brand-600 to-success-600 rounded-xl flex items-center justify-center mx-auto mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-brand-600 to-success-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:shadow-md transition-all duration-150 inline-flex items-center justify-center gap-2"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="border-2 border-brand-600 text-brand-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-all duration-150 inline-flex items-center justify-center gap-2"
            >
